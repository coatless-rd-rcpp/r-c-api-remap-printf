...
This function provides an example of how to call a function written
using R's C API. The function itself redirects output from the printf()
stream to R's Rprintf() so that it can be captured and manipulated.
